    ...
    <div className="bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
      ...
      <nav className="py-10 mb-12 flex justify-between">
            ...
            <ul className="flex items-center">
              ...
              <li><a className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8" href ="https://drive.google.com/file/d/12I4vxYLWVWj9lvuem1ob0Mj9-aHQbbsb/view?usp=sharing">Resume</a></li>
            </ul>
          </nav>
      <Main />
      <About />
